package sn.samaauto.web.rest;

import sn.samaauto.config.Constants;
import sn.samaauto.SNsamaautoApp;
import sn.samaauto.domain.Authority;
import sn.samaauto.domain.PersistentToken;
import sn.samaauto.domain.User;
import sn.samaauto.repository.AuthorityRepository;
import sn.samaauto.repository.PersistentTokenRepository;
import sn.samaauto.repository.UserRepository;
import sn.samaauto.security.AuthoritiesConstants;
import sn.samaauto.service.MailService;
import sn.samaauto.service.dto.UserDTO;
import sn.samaauto.web.rest.errors.ExceptionTranslator;
import sn.samaauto.web.rest.vm.KeyAndPasswordVM;
import sn.samaauto.web.rest.vm.ManagedUserVM;
import sn.samaauto.service.UserService;
...
@SpringBootTest(classes = SNsamaautoApp.class)
